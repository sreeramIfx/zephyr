...
static cy_stc_smif_hybrid_region_info_t *sfdp_slave_slot_0_region_info[16] = {
	&sfdp_slave_slot_0_region_info_storage[0],  &sfdp_slave_slot_0_region_info_storage[1],
	&sfdp_slave_slot_0_region_info_storage[2],  &sfdp_slave_slot_0_region_info_storage[3],
	&sfdp_slave_slot_0_region_info_storage[4],  &sfdp_slave_slot_0_region_info_storage[5],
	&sfdp_slave_slot_0_region_info_storage[6],  &sfdp_slave_slot_0_region_info_storage[7],
	&sfdp_slave_slot_0_region_info_storage[8],  &sfdp_slave_slot_0_region_info_storage[9],
	&sfdp_slave_slot_0_region_info_storage[10], &sfdp_slave_slot_0_region_info_storage[11],
	&sfdp_slave_slot_0_region_info_storage[12], &sfdp_slave_slot_0_region_info_storage[13],
	&sfdp_slave_slot_0_region_info_storage[14], &sfdp_slave_slot_0_region_info_storage[15],
};
#endif
